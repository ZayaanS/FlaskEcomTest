...
class TestBuyItem(BaseTest):
    ...
    def test_buying_item_error(self):
        # test buying an item if user does not have enough budget
        with self.app:
            with self.app_context:
                ...
                # assert item is purchased
                self.assertIn(b'Unfortunately, you don&#39;t have enough money to purchase laptop!', response.data)
